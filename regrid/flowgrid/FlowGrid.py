...
class FlowGrid():
    ...
    def exportVTK(self, fname):
        ...
        sWrite.SetInputData( self.sGrid )
        sWrite.SetFileName(fname)
        sWrite.Write()
...
class SUTRA( FlowGrid ):
    ...
    def loadPoints( self, fname, nx, ny, nz ):
    ...
    def loadPointsConnections( self, nodes, connections ):
...
def loadSUTRA( ):
    ...
    X = np.loadtxt("nodewise", comments="#")
    #                   x       y       z
